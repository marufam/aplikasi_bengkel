<div class="col-lg-12">
        ...
        <div class="row" style="margin-bottom: 10px">
            ...
            <div class="col-md-3 text-right">
                <form action="<?php echo site_url('ramal/index'); ?>" class="form-inline" method="get">
                    <div class="input-group">
                        ...
                        <span class="input-group-btn">
                            <?php 
                                ...
                                {
                                    ?>
                                    <a href="<?php echo site_url('ramal'); ?>" class="btn btn-default">Reset</a>
                                    <?php
                                }
                            ?>
		...
		<th>Action</th>
			...
			<td style="text-align:center">
				<?php 
				echo anchor(site_url('ramal/peramalan/'.$barang->kode_barang),'RAMAL','class="btn btn-danger"'); 
				?>
			</td>
		</tr>
                <?php
