				...
				<div class="portlet-body">
					<div class="task-content">
						...
						<div class="portlet-body form">
							<span><h5></h5></span>
							<div class="form-body">
								<?=form_open('Ramal/peramalan_uji/'.$this->uri->segment(3));?>
									<div class="form-group">
										...
										<div class="col-md-2">
											<input type="text" class="form-control" name="alpha" value="0.2">
										</div>
										<div class="col-md-1">
								...
								<table class="table table-responsive table-bordered">
									...
									<tr>
										...
										<th>Jumlah</th>
										<th>Ramal Jumlah</th>
										<th>Jumlah Ril yang di Ramal</th>
										<th>MAE</th>
										<th>MSE</th>
										<th>MAPE</th>
									</tr>
									...
									<tr>
										...
										<td><?=$data['jumlah']?> <?php $jumlah[]=$data['jumlah']; ?></td>
										<td><?= round($data['ramal']) ?><?php $ramal[]=substr($data['ramal'], 0,4); ?></td>
										<td><?=$data['tahun_yang_diramal']?> <?php $jumlah2[]=$data['tahun_yang_diramal']; ?> </td>
										<td><?= substr($data['MAE'], 0,4) ?></td>
										<td><?= substr($data['MSE'], 0,4) ?></td>
										<td><?= substr($data['MAPE']*100, 0, 4)."%"?></td>
									</tr>
									
									<?php } ?>
									<tbody>
											<tr>
												<td colspan="6"><b>Rata-rata</b></td>
												<td><?=  round(substr($mae_avg, 0,4)) ?></td>
												<td><?=  round(substr($mse_avg, 0,4)) ?></td>
												<td><?= round(substr($mape_avg*100, 0,4))."%" ?></td>
											</tr>
										</tbody>
									<?php }else{
										?>
